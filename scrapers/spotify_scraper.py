...
#     time.sleep(2)  
#     driver.title
#     songs = driver.find_elements(By.CSS_SELECTOR,"div.GzWlvg0xI8IJiSoY.u5wEtE_x69YxkLdv")
#     song_data = []
#     for song in songs:
#         title = song.find_element(By.CSS_SELECTOR, "div.e-10451-text.encore-text-body-medium.encore-internal-color-text-base.lkqOvzjBxm0err2b.standalone-ellipsis-one-line").text
#         artist = song.find_element(By.CSS_SELECTOR, "div.e-10451-text.encore-text-body-small a").text
#         time = song.find_element(By.CSS_SELECTOR, "div.e-10451-text.encore-text-body-small.encore-internal-color-text-subdued.Na06TEk5cCR4FwBd").text
